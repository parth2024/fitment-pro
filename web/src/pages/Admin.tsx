          ...
          >
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                <IconUpload size={56} color="white" style={{ position: "relative", zIndex: 1 }} />
              </div>
                ...
                <div style={{
                  ...
                  <Card 
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow = "0 30px 60px rgba(59, 130, 246, 0.25), 0 0 0 1px rgba(59, 130, 246, 0.1)";
                    }}
                    onMouseLeave={(e) => {
                  ...
                  >
                    ...
                    <Stack align="center" gap="xl" style={{ position: "relative", zIndex: 1 }}>
                      ...
                      <div style={{
                        ...
                        <IconDatabase size={64} color="white" style={{ position: "relative", zIndex: 1 }} />
                      </div>
                      ...
                      <div 
                        ...
                        onMouseEnter={(e) => {
                          e.currentTarget.style.background = "linear-gradient(145deg, rgba(59, 130, 246, 0.08) 0%, rgba(139, 92, 246, 0.08) 100%)";
                          e.currentTarget.style.borderColor = "#8b5cf6";
                          e.currentTarget.style.transform = "scale(1.02)";
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.background = "linear-gradient(145deg, rgba(59, 130, 246, 0.03) 0%, rgba(139, 92, 246, 0.03) 100%)";
              ...
              <Grid.Col span={6}>
                <div style={{
                  ...
                  <Card 
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.transform = "translateY(-12px) scale(1.02)";
                      e.currentTarget.style.boxShadow = "0 30px 60px rgba(34, 197, 94, 0.25), 0 0 0 1px rgba(34, 197, 94, 0.1)";
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = "translateY(0px) scale(1)";
                      e.currentTarget.style.boxShadow = "0 10px 25px rgba(0, 0, 0, 0.1)";
                  ...
                  >
                    ...
                    <Stack align="center" gap="xl" style={{ position: "relative", zIndex: 1 }}>
                      ...
                      <div style={{
                        ...
                        <IconFile size={64} color="white" style={{ position: "relative", zIndex: 1 }} />
                      </div>
                      ...
                      <div 
                        style={{
                          ...
                          alignItems: "center",
                          justifyContent: "center",
                          background: "linear-gradient(145deg, rgba(34, 197, 94, 0.03) 0%, rgba(6, 214, 160, 0.03) 100%)",
                          transition: "all 0.3s ease",
                          cursor: "pointer",
                          position: "relative",
                          overflow: "hidden"
                        ...
                        onMouseEnter={(e) => {
                          e.currentTarget.style.background = "linear-gradient(145deg, rgba(34, 197, 94, 0.08) 0%, rgba(6, 214, 160, 0.08) 100%)";
                          e.currentTarget.style.borderColor = "#06d6a0";
                          e.currentTarget.style.transform = "scale(1.02)";
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.background = "linear-gradient(145deg, rgba(34, 197, 94, 0.03) 0%, rgba(6, 214, 160, 0.03) 100%)";
            ...
            <div style={{ 
              ...
              <Button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = "0 25px 50px rgba(102, 126, 234, 0.4), inset 0 1px 0 rgba(255,255,255,0.2)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = "translateY(0px) scale(1)";
                  e.currentTarget.style.boxShadow = "0 20px 40px rgba(102, 126, 234, 0.3), inset 0 1px 0 rgba(255,255,255,0.2)";
                }}
              >
                Upload Files
              </Button>
